...
public class AdapterVerifyResult extends RecyclerView.Adapter<ViewHolder> {

    private final Context context;

    private final SortedList<File> items;
    private List<Integer> states;
    private Map<String, Integer> verifiedFiles;
    ...
    public AdapterVerifyResult(Context context) {
...
//        holder.setData(get(position), getSelected(position), this.states.get(position));
        if (verifiedFiles != null) {
            if (verifiedFiles.containsKey(get(position).getName())) {
                holder.setData(get(position), getSelected(position), this.verifiedFiles.get(get(position).getName()));
            } else {
    ...
    public void addVerifiedFiles(Map<String, Integer> vf) {
        this.verifiedFiles = vf;
    }

    public void addVerifiedStates(List<Integer> input) {
        this.states = input;
    }
